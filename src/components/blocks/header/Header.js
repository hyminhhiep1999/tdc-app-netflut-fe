            ...
            <Container fluid>
                ...
                <Collapse isOpen={isOpen} navbar>
                    <Nav className="mr-auto" navbar>
                        ...
                        <NavItem  className="px-2">
                            <NavLink tag={Link} className="nav-link" to="/contact">Phim Mới</NavLink>
                        </NavItem>
                        <NavItem className="px-2">
                            <NavLink tag={Link} to="/contact">Phim Bộ</NavLink>
                        </NavItem>
                        <NavItem className="px-2">
                            <NavLink tag={Link} to="/">Phim Lẻ</NavLink>
                        </NavItem>
                        <NavItem className="px-2">
                            <NavLink tag={Link} to="/">Phim Chiếu Rạp</NavLink>
                        </NavItem>
                        <NavItem className="px-2">
                            <NavLink tag={Link} to="/">Thiếu Nhi </NavLink>
                        </NavItem>
                        <NavItem className="px-2">
                            <NavLink tag={Link} to="/">Anime</NavLink>
                        </NavItem>
